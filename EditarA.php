...
<div class="input-group has-validation">
  ...
  <input type="text" class="valorEnv" id="valorEnv" value="EditarA" name="act" visibility: hidden>
  <input type="text" class="valorEnv" id="valorEnv" value="<?=$id?>" name="id" visibility: hidden>

  <div class="col-2">
  <button class="btn btn-primary"><i class="fa-solid fa-user-plus"></i><span>Editar usuario</span></button>
  </div>
