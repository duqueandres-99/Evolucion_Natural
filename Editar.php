					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Editar <span clsas="d-block"></span>Usuario</h1>
								<p class="mb-4">En esta seccion puedes editar los datos del usuario que seleccionaste.</p>
								</div>
						</div>
						<div class="col-lg-6">
...
<div class="input-group has-validation">
  ...
  <input type="text" class="valorEnv" id="valorEnv" value="Editar" name="act" visibility: hidden>
  <input type="text" class="valorEnv" id="valorEnv" value="<?=$id?>" name="id" visibility: hidden>

  <div class="col-2">
  <button class="btn btn-primary"><i class="fa-solid fa-pen"></i><span> Editar usuario</span></button>
  </div>
