...
echo "<td>";
	...
	echo "<tr>";
	echo "<form action='Editar.php?ed' method='post'>";
	...
	echo "<tr>";
	echo "<form action='detalleuM.php' method='post'>";
...
?>
		...
		<button style="menu" type="button" class="btn btn-primary ml-2 mb-2"><a class="nav-link" href="crearU.php"><i class="fa-solid fa-user-plus"></i> Crear usuario</a></button>
...
?>
		...
		<button style="menu" type="button" class="btn btn-primary ml-2 mb-2"><a class="nav-link" href="crearP.php"><i class="fa-solid fa-circle-plus"></i> Añadir articulo</a></button>
