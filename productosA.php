		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
			...
			<div class="container">
				...
				<li >
						...
						<li><a class="nav-item active" href="productosA.php">Productos</a></li>
		      	...
		      	<div class="row">
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="#">
							<img src="images/matera.png" class="img-fluid product-thumbnail">
							<h3 class="product-title">Matera de 8L</h3>
