					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Cultiva a otro nivel! </h1>
								<p class="mb-4">Te apoyamos a cultivar, brindando una solucion tecnologica y acompañamiento continuo.</p>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleDark" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
			...
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-6">
						...
						<p>Contamos con un equipo motivado por la naturaleza y dispuesto a ayudarte.</p>
					...
					<div class="col-lg-5">
						<div class="img-wrap">
							<img src="images/whyus.jpg" alt="Image" width="600" height="500" class="img-fluid">
						</div>
					</div>
			...
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-7 mb-5 mb-lg-0">
						<div class="imgs-grid">
							<div class="grid grid-1"><img src="images/fam.jpg" alt="Untree.co"></div>
							<div class="grid grid-2"><img src="images/dash.gif" alt="Untree.co"></div>
							<div class="grid grid-3"><img src="images/mom.jpg" alt="Untree.co"></div>
						</div>
					</div>
					<div class="col-lg-5 ps-lg-5">
						<h2 class="section-title mb-4">Te ayudamos a hacer un cultivo en cualquier espacio.</h2>
						<p>Hacemos posibles tus sueños de tener un cultivo automatizado sin importar el espacio que tengas. Te apoyaremos durante todo el proceso, desde la siembra hasta la cosecha con ayuda de nuestra tecnologia.</p>

						<ul class="list-unstyled custom-list my-4">
							<li>Te ofrecemos los mejores productos.</li>
							<li>Te acompañamos en tu proceso.</li>
							<li>Contamos con un equipo a tu disposicion.</li>
							<li>Con nuestra tecnologia cultivar sera mas facil.</li>
						</ul>
		...
		<div class="popular-product">
			<div class="container">
				<div class="row">
				<center><h3>Productos populares</h3><br><br></center>
					<div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
						<div class="product-item-sm d-flex">
							...
							<div class="thumbnail">
								...
								<img src="images/VitaminaE.png" alt="Image" class="img-fluid">
							</div>
							<div class="pt-3">
								<h3>Vitamina E</h3>
								<p>Actuar como un centinela  en los vegetales, enviando señales moleculares desde el cloroplasto. </p>
					...
					<div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
						<div class="product-item-sm d-flex">
							<div class="thumbnail">
								<img src="images/matera.png" alt="Image" class="img-fluid">
							</div>
							<div class="pt-3">
								<h3>Matera de 8L</h3>
								<p>Capacidad de 8 litros para la expansion radicular de tus plantas. </p>
								<p><a href="#">Comprar</a></p>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
						<div class="product-item-sm d-flex">
							<div class="thumbnail">
								<img src="images/arroz.png" alt="Image" class="img-fluid">
							</div>
							<div class="pt-3">
								<h3>Semillas de arroz</h3>
								<p>Con esta genetica tendras una cosecha de arroz 100% organico.</p>
								<p><a href="#">Comprar</a></p>
							</div>
						</div>
					</div>
										...
										<div class="col-lg-8 mx-auto">
											...
											<div class="testimonial-block text-center">
												<blockquote class="mb-5">
													<p>&ldquo;Gracias a la tecnología y asesoría de <b>evolución natural</b>, logré tener mis propios huertos en mi apartamento. Es fascinante poder cosechar mis alimentos y preparar mis batidos con frutas más orgánicas.&rdquo;</p>
												</blockquote>

												<div class="author-info">
													<div class="author-pic">
														<img src="images/persona1.jpg"  class="img-fluid">
													</div>
													<h3 class="font-weight-bold">Lina Fernanda</h3>
								...
								<div class="item">
									<div class="row justify-content-center">
										<div class="col-lg-8 mx-auto">
											...
											<div class="testimonial-block text-center">
												<blockquote class="mb-5">
													<p>&ldquo;Somos un grupo de personas capacitadas para brindar la mejor asesoria a nuestros clientes. Con nuestros productos especializados, nuestra asesoria <b>24/7</b> y nuestro equipo de diseñadores hacemos que cuidar tus cultivos sea mas sencillo.&rdquo;</p>
												</blockquote>

												<div class="author-info">
													<div class="author-pic">
														<img src="images/persona3.jpg" alt="Maria Jones" class="img-fluid">
													</div>
													<h3 class="font-weight-bold">Samuel mora</h3>
													<span class="position d-block mb-3">Co Fundador, Evolucion Natural Corp.</span>
												</div>
								...
								<div class="item">
									<div class="row justify-content-center">
										<div class="col-lg-8 mx-auto">
											...
											<div class="testimonial-block text-center">
												<blockquote class="mb-5">
													<p>&ldquo;<b>Evolución natural</b> es una compañia diseñada para implementar la tecnologia, contribuir a la naturaleza, fomentar la agricultura y ayudar a las personas interesadas, adaptando sus espacios para permitirles tener cosechas de cualquier tipo de especie.&rdquo;</p>
												</blockquote>

												<div class="author-info">
													<div class="author-pic">
														<img src="images/lex.jpg"  class="img-fluid">
													</div>
													<h3 class="font-weight-bold">Andres Felipe Rodriguez Duque</h3>
													<span class="position d-block mb-3">Fundador, Evolucion Natural Corp.</span>
												</div>
			...
			<div class="container">
				<div class="row mb-5">
					...
					<div class="col-md-6 text-start text-md-end">
						<a href="#" class="more">Todas las publicaciones</a>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div class="post-entry">
							<a href="#" class="post-thumbnail"><img src="images/cosecha1.jpg"  class="img-fluid"></a>
							<div class="post-content-entry">
								<h3><a href="#">Mi primera cosecha</a></h3>
								<div class="meta">
									<span>Por <a href="#">Lina Fernanda</a></span> <span>en <a href="#">Oct 23, 2023</a></span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div class="post-entry">
							<a href="#" class="post-thumbnail"><img src="images/Panel.jpg" width="600" class="img-fluid"></a>
							<div class="post-content-entry">
								<h3><a href="#">Estrenando panel led</a></h3>
								<div class="meta">
									<span>Por <a href="#">Olga Duque</a></span> <span>en <a href="#">Dic 20, 2023</a></span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div class="post-entry">
							<a href="#" class="post-thumbnail"><img src="images/hidro.jpg" alt="Image" class="img-fluid"></a>
							<div class="post-content-entry">
								<h3><a href="#">Usando la hidroponia en mis cultivos</a></h3>
								<div class="meta">
									<span>Por <a href="#">Helen Prieto</a></span> <span>en <a href="#">Dic 21, 2023</a></span>
								</div>
							</div>
						</div>
					</div>
