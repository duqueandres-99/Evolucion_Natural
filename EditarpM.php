					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Editar <span clsas="d-block"></span>Articulo</h1>
								<p class="mb-4">En esta seccion podras modificar los datos del articulo seleccionado.</p>
								</div>
						</div>
						<div class="col-lg-6">
...
<div class="input-group has-validation">
  ...
  <div class="col-4">
  <button class="btn btn-primary"><i class="fa-solid fa-pen"></i><span> Editar articulo</span></button>
  </div>
