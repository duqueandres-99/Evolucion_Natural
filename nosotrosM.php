	...
	<body>
					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Quienes somos</h1>
								<p class="mb-4">Nuestro equipo de trabajo se enfoca en la implementacion de cultivos utilizando herramientas tecnologicas.</p>
								</div>
						</div>
						<div class="col-lg-7">
		...
		<div class="why-choose-section">
			...
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-6">
						<h2 class="section-title">Evolución Natural</h2><br>
						<p>Somos una compañía motivada por la naturaleza y la tecnología.
						   Nos dedicamos a proveer a nuestros clientes con los mejores
						   productos agrícolas del mercado como materas, sustratos, semillas,
						   vitaminas. Etc. También brindamos una herramienta tecnológica por 
						   medio de nuestros sistemas y nuestra aplicación, damos la posibilidad de tener
						   un monitoreo y control a distancia de sus cultivos. Además, nuestro equipo
						   de trabajo esta las 24 horas de los 7 días dispuestos a ayudar a nuestros 
						   clientes con asesorías y resolución de problemas.
						</p>
					...
					<div class="col-lg-5">
						<div >
							<img src="images/logo.png" alt="Image" width="1000" height="500" class="img-fluid">
						</div>
					</div>
