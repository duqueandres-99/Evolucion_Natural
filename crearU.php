					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Creacion de <span clsas="d-block"></span>Usuario</h1>
								<p class="mb-4">En esta seccion puedes crear un usuario, por defecto la clave es 'N123456789'.</p>
								</div>
						</div>
						<div class="col-lg-6">
...
<div class="input-group has-validation">
  ...
  <input type="text" class="valorEnv" id="valorEnv" value="Crear" name="act" visibility: hidden>
