					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Examinar <span clsas="d-block"></span>Articulo</h1>
								<p class="mb-4">En esta seccion podras ver los detalles de la publicacion del articulo que seleccionaste.</p>
								</div>
						</div>
						<div class="col-lg-6">
...
<form method="post" action="EditarpM.php?usuario=MASTER">
